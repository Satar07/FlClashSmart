...
- fix: add write permissions to changelog job

- Merge upstream/main into Smart (v0.8.94)

- Upstream changes (chen08209/FlClash):

- - Custom overwrite, run on demand

- - rust_api plugin (IPC), setup plugin, wifi_ssid plugin

- - Windows ARM64 support, build optimizations

- - New proxy types: tailscale, openvpn, gost-relay, xhttp, etc.

- - Database schema changes, action provider refactoring

- - i18n updates (en, ja, ru, zh_CN)

- Smart Core (preserved):

- - Smart proxy group (smart.go, component/smart/*)

- - LightGBM model inference (vernesong/leaves)

- - Model preload (assets/data/Model.bin)

- - Smart cache and stats (smart_cache.go)

- CI (preserved):

- - Firebase google-services.json

- - Package name com.flsmart.clash

- - Per-file sha256 generation

- - No F-Droid publishing

- Docs: Add MERGE_UPSTREAM.md guide
